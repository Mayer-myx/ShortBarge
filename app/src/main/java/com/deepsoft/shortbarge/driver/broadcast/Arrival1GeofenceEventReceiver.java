...
public class Arrival1GeofenceEventReceiver extends BroadcastReceiver {

    private final static String TAG = "Arrival1GeofenceEventReceiver";
    ...
    public void onReceive(Context context, Intent intent) {
        if (intent == null || !ACTION_TRIGGER_GEOFENCE_ARRIVAL1.equals(intent.getAction())) {
            return;
        }
